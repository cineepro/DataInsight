//apps/studio/src/engine/flexible/compareDatasetSnapshots.ts
...
/**
 * Compare deux datasets distincts (ex: deux fichiers reçus à deux
 * périodes différentes) sur leurs colonnes "mesure" communes. Contrairement
 * à comparePeriodCrossMetrics (engine/restaurant), ici on ne connaît pas
 * les métriques à l'avance — elles sont déterminées par le mapping.
 */
